...
class OperaSetup {
    constructor() {
        ...
        this.outputRoot = this.sourceRoot; // Generate files relative to repo root, not cwd
        this.quiet = false;
...
`;
        ...
        // VS expects this in the current working directory (platforms/windows/)
        const depPath = process.cwd().includes('platforms/windows') 
            ? path.join(process.cwd(), 'operasetup.dep')
            : path.join(this.outputRoot, 'platforms', 'windows', 'operasetup.dep');
