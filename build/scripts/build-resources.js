...
// Create specific expected output files
const expectedFiles = [
    // VS output dialog dummy
    { 
        path: path.resolve(targetDir, 'defaults', 'dialog_dummy.ini'),
        content: `; Generated by build-resources.js
[Dialog]
dummy=1
`
    },
    // Dependency file for operasetup
    {
        path: path.resolve(sourceDir, 'platforms', 'windows', 'operasetup.dep'),
        content: `# Generated by build-resources.js at ${new Date().toISOString()}
operasetup.dep
`
    },
    // Operasetup header file
    {
        path: path.resolve(sourceDir, 'modules', 'hardcore', 'base', 'operasetup.h'),
        content: `/* Generated by build-resources.js */
#ifndef OPERASETUP_H
#define OPERASETUP_H

#define OPERA_VERSION_MAJOR 12
#define OPERA_VERSION_MINOR 15
#define OPERA_VERSION_PATCH 0

#endif // OPERASETUP_H
`
    },
    // Hardcoded searches include file
    {
        path: path.resolve(sourceDir, 'adjunct', 'desktop_util', 'search', 'hardcoded_searches.inl'),
        content: `/* Generated by build-resources.js */
// Hardcoded search engines
/* Empty for now */
`
    }
];
...
expectedFiles.forEach(file => {
    try {
        ...
        console.log(`Created expected file: ${file.path}`);
    } catch (error) {
