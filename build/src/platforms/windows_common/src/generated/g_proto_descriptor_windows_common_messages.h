...
#ifndef G_PROTO_DESCRIPTOR_WINDOWS_COMMON_MESSAGES_H
#define G_PROTO_DESCRIPTOR_WINDOWS_COMMON_MESSAGES_H
...
{
public:
	OpWindows_commonMessages_Descriptors();
	~OpWindows_commonMessages_Descriptors();
	...
	enum // Message offset + count
	{
		...
		_gen_MessageOffs_windows_plugin_window_info_,
		_gen_MessageOffs_windows_plugin_window_info_response_,
	...
	enum // message IDs
	{
		...
		, _gen_MsgID_windows_plugin_window_info_
		, _gen_MsgID_windows_plugin_window_info_response_
	};
...
#endif // G_PROTO_DESCRIPTOR_WINDOWS_COMMON_MESSAGES_H
