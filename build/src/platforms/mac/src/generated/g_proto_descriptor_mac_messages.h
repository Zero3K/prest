...
#ifndef G_PROTO_DESCRIPTOR_MAC_MESSAGES_H
#define G_PROTO_DESCRIPTOR_MAC_MESSAGES_H
...
public:
	...
	enum // Message offset + count
	{
		...
		_gen_MessageOffs_mac_plugin_context_menu_shown_,
		_gen_MessageOffs_mac_plugin_cursor_shown_,
		_gen_MessageOffs_mac_plugin_desktop_window_movement_,
		_gen_MessageOffs_mac_plugin_fullscreen_,
		_gen_MessageOffs_mac_plugin_ime_text_,
		_gen_MessageOffs_mac_plugin_info_,
		_gen_MessageOffs_mac_plugin_info_response_,
		_gen_MessageOffs_mac_plugin_update_view_,
		_gen_MessageOffs_mac_plugin_visibility_,
		_gen_MessageOffs_mac_plugin_window_shown_,
	...
	enum // message IDs
	{
		...
		, _gen_MsgID_mac_plugin_context_menu_shown_
		, _gen_MsgID_mac_plugin_cursor_shown_
		, _gen_MsgID_mac_plugin_desktop_window_movement_
		, _gen_MsgID_mac_plugin_fullscreen_
		, _gen_MsgID_mac_plugin_ime_text_
		, _gen_MsgID_mac_plugin_info_
		, _gen_MsgID_mac_plugin_info_response_
		, _gen_MsgID_mac_plugin_update_view_
		, _gen_MsgID_mac_plugin_visibility_
		, _gen_MsgID_mac_plugin_window_shown_
	};
...
#endif // G_PROTO_DESCRIPTOR_MAC_MESSAGES_H
