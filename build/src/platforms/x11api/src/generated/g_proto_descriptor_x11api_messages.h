...
#ifndef G_PROTO_DESCRIPTOR_X11API_MESSAGES_H
#define G_PROTO_DESCRIPTOR_X11API_MESSAGES_H
...
public:
	...
	enum // Message offset + count
	{
		...
		_gen_MessageOffs_browser_window_information_,
		_gen_MessageOffs_browser_window_information_response_,
		_gen_MessageOffs_plugin_gtk_plug_added_,
		_gen_MessageOffs_plugin_parent_changed_,
	...
	enum // message IDs
	{
		...
		, _gen_MsgID_browser_window_information_
		, _gen_MsgID_browser_window_information_response_
		, _gen_MsgID_plugin_gtk_plug_added_
		, _gen_MsgID_plugin_parent_changed_
	};
...
#endif // G_PROTO_DESCRIPTOR_X11API_MESSAGES_H
