...
#ifndef G_PROTO_DESCRIPTOR_WINDOWCOMMANDER_MESSAGES_H
#define G_PROTO_DESCRIPTOR_WINDOWCOMMANDER_MESSAGES_H
...
{
public:
	OpWindowcommanderMessages_Descriptors();
	~OpWindowcommanderMessages_Descriptors();
	...
	enum // Message offset + count
	{
		...
		_gen_MessageOffs_popup_menu_request_menu_item_,
		_gen_MessageOffs_popup_menu_request_menu_item_list_,
		_gen_MessageOffs_popup_menu_request_,
	...
	enum // message IDs
	{
		...
		, _gen_MsgID_popup_menu_request_menu_item_
		, _gen_MsgID_popup_menu_request_menu_item_list_
		, _gen_MsgID_popup_menu_request_
	};
...
#endif // G_PROTO_DESCRIPTOR_WINDOWCOMMANDER_MESSAGES_H
