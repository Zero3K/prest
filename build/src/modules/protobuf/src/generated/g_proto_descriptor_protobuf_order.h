...
#ifndef G_PROTO_DESCRIPTOR_PROTOBUF_ORDER_H
#define G_PROTO_DESCRIPTOR_PROTOBUF_ORDER_H
...
public:
	...
	enum // Message offset + count
	{
		...
		_gen_MessageOffs_test_op_string_order_,
		_gen_MessageOffs_test_order_,
	...
	enum // message IDs
	{
		...
		, _gen_MsgID_test_op_string_order_
		, _gen_MsgID_test_order_
	};
...
#endif // G_PROTO_DESCRIPTOR_PROTOBUF_ORDER_H
