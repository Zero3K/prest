...
#ifndef G_PROTO_DESCRIPTOR_HARDCORE_COMPONENT_H
#define G_PROTO_DESCRIPTOR_HARDCORE_COMPONENT_H
...
{
public:
	OpHardcoreComponent_Descriptors();
	~OpHardcoreComponent_Descriptors();
	...
	enum // Message offset + count
	{
		...
		_gen_MessageOffs_typed_message_address_,
		_gen_MessageOffs_typed_message_,
	...
	enum // message IDs
	{
		...
		, _gen_MsgID_typed_message_address_
		, _gen_MsgID_typed_message_
	};
...
#endif // G_PROTO_DESCRIPTOR_HARDCORE_COMPONENT_H
